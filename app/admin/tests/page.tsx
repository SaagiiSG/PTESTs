...
import { Search, Plus, Edit, Trash2, Eye, BookOpen, MoreHorizontal, Target, Brain, Stethoscope, User, ToggleLeft, ToggleRight, X } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {isViewModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 scale-75">
          <div className="relative w-[98vw] h-[98vh] bg-transparent rounded-3xl flex flex-col overflow-hidden">
            {/* Silk Background Layer - z-0 */}
            ...
            {/* Glassmorphism Container - z-10 */}
            <div className="relative z-10 w-full h-full bg-white/5 backdrop-blur-sm border border-white/20 rounded-3xl flex flex-col overflow-hidden shadow-2xl">
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-white/20 bg-white/10 backdrop-blur-md rounded-t-3xl flex-shrink-0">
                <div>
                  <h2 className="text-2xl font-bold text-white drop-shadow-lg">Test Preview</h2>
                ...
                <Button
                  ...
                  className="h-10 w-10 p-0 hover:bg-white/20 rounded-full transition-all duration-200 hover:scale-105 text-white hover:text-white"
                >
                  <X className="w-5 h-5" />
                </Button>
              </div>
              ...
              {/* Content */}
              <div className="flex-1 p-6 bg-transparent overflow-scroll">
                {selectedTest && (
                  <div className="w-full h-full">
                    {loadingEmbed ? (
                      <div className="h-full flex items-center justify-center">
                        <div className="text-center">
                          <div className="relative mb-6">
                            <div className="w-20 h-20 border-4 border-white/20 rounded-full animate-spin mx-auto"></div>
                            <div className="absolute inset-0 w-20 h-20 border-4 border-transparent border-t-white rounded-full animate-spin mx-auto"></div>
                          </div>
                          <p className="text-xl font-semibold text-white mb-2 drop-shadow-lg">Loading test preview...</p>
                          <p className="text-sm text-white/70 drop-shadow-md">Please wait while we prepare your test</p>

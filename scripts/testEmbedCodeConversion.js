// Test script for embed code conversion
// Run with: node scripts/testEmbedCodeConversion.js
...
// Test cases for embed code conversion
const testCases = [
  {
...
console.log('🧪 Testing Embed Code Conversion\n');
...
console.log('\n🎯 Test Summary:');
console.log('The embed code conversion utility should:');
console.log('1. Convert quiz-maker links to iframes');
console.log('2. Convert direct URLs to iframes');
console.log('3. Convert script tags to iframes when possible');
console.log('4. Convert anchor tags to iframes');
